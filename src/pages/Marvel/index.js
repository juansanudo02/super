...
<section>
    ...
    <div className="item">
        <h2>Hawkeye</h2> 
        <img src='https://pbs.twimg.com/media/FDeN1vMVIAYa42A.jpg:large' width="300px" alt="Hawkeye"/>
        <p><strong>Pertenece a: <h3>Marvel Entertainment</h3></strong></p>
        <p>
    ...
    <div className="item">
        <h2>Spider-Man</h2> 
        <img src='https://terrigen-cdn-dev.marvel.com/content/prod/1x/deadlysm2022001_cov.jpg' width="300px" alt="Spider-man"/>
        <p><strong>Pertenece a: <h3>Marvel Entertainment</h3></strong></p>
        <p>
